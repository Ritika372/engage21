...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"subject.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addSubject = exports.addNotes = void 0;
...
var addNotes = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "POST",
              url: "/api/subjects/".concat(id, "/addNotes"),
              data: data
            });
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Notes added successfully!");
              window.setTimeout(function () {
                location.assign("/subjects");
              }, 1500);
            }
  ...
  return function addNotes(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
...
exports.updateQuiz = exports.evaluateQuiz = exports.addQuiz = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Quiz added successfully!");
              window.setTimeout(function () {
...
var updateQuiz = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(quizid, active) {
    var res, message;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              message = "".concat(active ? "Quiz is active now." : "Quiz is disabled for students");
  ...
  return function updateQuiz(_x5, _x6) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Question added successfully!");
              window.setTimeout(function () {
                location.assign("/quizzes/".concat(data.quiz, "/questions"));
              }, 1500);
            }
...
var addSubjectForm = document.getElementById("addSubject-form");
var addQuizForm = document.getElementById("addQuiz-form");
...
var addNotesForm = document.getElementById("addNotes-form");
...
var markQuizActive = document.getElementsByName("markQuiz-active");
...
if (addSubjectForm) {
  addSubjectForm.addEventListener("submit", function (event) {
    event.preventDefault();
    var name = document.querySelector("#addSubject-title").value;
    var description = document.querySelector("#addSubject-description").value;
    (0, _subject.addSubject)(name, description);
  });
}
...
if (addQuizForm) {
  addQuizForm.addEventListener("submit", function (event) {
    ...
    data.numberOfQuestions = document.getElementById("addQuiz-numberOfQuestions").value;
    data.subject = document.getElementById("addQuiz-subject").value;
    data.active = document.getElementById("addQuiz-active").checked;
    data.negativeMarking = parseFloat(document.getElementById("addQuiz-negMarking").value);
    data.timer = parseFloat(document.getElementById("addQuiz-timer").value) * 60;
    (0, _quiz.addQuiz)(data);
  });
}

if (addQuesForm) {
  addQuesForm.addEventListener("submit", function (event) {
    event.preventDefault();
    var data = {};
...
if (markQuizActive) {
  markQuizActive.forEach(function (input) {
    input.addEventListener("change", function (event) {
      var quizid = input.dataset.quizid;
      var active = input.checked;
      (0, _quiz.updateQuiz)(quizid, active);
    });
  });
}
...
if (addNotesForm) {
  addNotesForm.addEventListener("submit", function (event) {
    event.preventDefault();
    var subjectId = document.getElementById("addNotes-subject").value;
